...
export const LoadingUnloadingGoods: React.FC = () => {
  ...
  const sendRelocationToAPI = async (relocation: boolean) => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:8080/api/user/patchLoadingUnloadingGoods", {
        method: "PATCH",
        headers: {
  ...
  return (
    <div className="mt-4">
      <h1 className="text-2xl">Would you be willing to load and/or unload goods?</h1>
