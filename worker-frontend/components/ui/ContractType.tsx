...
export const ContractType: React.FC = () => {
  ...
  const sendContractTypeToAPI = async (contractType: string) => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:8080/api/user/patchDriverContractType", {
        method: "PATCH",
        headers: {
  ...
  return (
    <div className="mt-4">
      <h1 className="text-2xl">What kind of contract are you looking for?</h1>
